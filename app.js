document.addEventListener('DOMContentLoaded', function() {
    function updateTime() {
        let anniversary = "2024-07-08";
        let startDate = new Date(anniversary);
        let now = new Date();
        ...
        if (now.getDate() < startDate.getDate()) {
            months--;
            let prevMonth = new Date(now.getFullYear(), now.getMonth() - 1, startDate.getDate());
    ...
    setInterval(updateTime, 1000); // Update every second if you want real-time updates
});
